...
const BankApp = () => {
	...
	return (
	<div className="bg">
		<h2 id="heading"> Bank App- Create Account,Transfer and Deposit </h2>
		...
		<h4>Click here to Create your account. Make sure you are connected to Wallet</h4>
			...
			<form onSubmit={DepositBalance}>
					<h3> Deposit Money </h3>
						<p> Deposit Amount </p>
						<input type='number' id='depositAmount' min='0' step='5'/>
			...
			<form onSubmit={WithdrawBalance}>
					<h3> Withdraw Money </h3>
						<p>Withdraw Amount </p>
						<input type='number' id='withdrawAmount' min='0' step='5'/>
